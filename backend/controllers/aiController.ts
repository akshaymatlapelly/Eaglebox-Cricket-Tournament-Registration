// REFERENCE BACKEND AI AGENT CONTROLLER
...
export function parseAgentCommand(query: string, isAdmin: boolean = false): AIAgentResponse {
  ...
  // 1. Register Team
  // e.g., "register my team Super Kings to IPL Cricket Cup 2026"
  ...
  // e.g., "upgrade membership to gold"
  ...
  // e.g., "download certificate" or "get winner certificate"
  ...
  // e.g., "show tournaments above 50000" or "list expensive tournaments"
  ...
  if (isAdmin) {
    // 5. Create Tournament
    // e.g., "create summer league tournament at chinnaswamy"
    ...
    // 6. Generate Fixtures
    // e.g., "generate fixtures for ipl cup"
  ...
  return {
    success: true,
    message: `I'm here as your CricketHub Pro assistant. You can ask me details about tournaments, memberships, or match scores. Try commands like "register team Mumbai to IPL Cup" or "upgrade membership to gold".`,
    action: {
